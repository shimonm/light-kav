...
_connection = psycopg2.connect("dbname='{}' user='postgres' host='{}' password='lightkavwins'".format(dbname, db_url))
...
def insert_ride(ride):
    ...
    cur.execute("INSERT INTO rides (user_id, ride_code ,payment ,payment_hash) VALUES (%s, %s, %s, %s)", (
        ride.user_id, ride.ride_code, ride.amount_paid, ride.payment_hash))
    _connection.commit()
